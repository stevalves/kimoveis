...
userRoutes.patch('/:id', validateData(userUpdateSchema), userExistsMiddleware, validateTokenMiddleware, updateUserController)
userRoutes.delete('/:id', userExistsMiddleware, validateTokenMiddleware, deleteUserController)
